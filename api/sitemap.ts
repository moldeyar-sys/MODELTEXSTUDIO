...
const GUIA_SLUGS = [
  'como-hacer-moldes-de-ropa-paso-a-paso',
  'formatos-de-molderia-digital',
  'telas-por-tipo-de-prenda',
  'medidas-corporales-para-moldes-de-ropa',
  'curva-de-talles-industrial',
  'tabla-de-medidas-industriales',
  'tabla-de-medidas-s-a-xl-dama-hombre-nino',
  'como-hacer-el-molde-base-de-un-pantalon',
  'como-hacer-el-molde-base-de-una-falda',
  'consumo-de-tela-por-prenda',
  'como-calcular-consumo-de-tela-con-el-rinde',
  'costeo-de-una-prenda',
  'como-escalar-patrones-de-costura',
  ...
  'exportar-y-convertir-dxf-entre-optitex-y-audaces',
  'que-es-el-patronaje-industrial',
  'diferencia-entre-molderia-y-patronaje',
  'programas-gratis-de-molderia-digital',
  'como-digitalizar-patrones-de-papel',
  'ficha-tecnica-de-diseno-para-taller-de-confeccion',
  'arrugas-en-el-tiro-del-pantalon-causas-y-correccion',
  'conversion-de-pulgadas-a-centimetros-para-molderia',
  'diccionario-ingles-espanol-de-molderia-y-costura',
  'armar-una-coleccion-con-moldes-digitales',
  'como-elegir-el-nombre-de-una-marca-de-moldes-o-ropa',
  'copy-para-vender-moldes-digitales-en-instagram',
